...
const MenuBar = ({ editor, callback }: { editor: Editor; callback: any }) => {
  if (!editor) {
    return null;
  }
  ...
  return (
    <div className="">
      <div className="flex flex-row     flex-wrap   p-[10px]">
        <div className="space-x-2 flex justify-start ">
          ...
          <button
            onClick={callback}
            className="ml-12 px-5 rounded-md py-2 bg-blue-600 text-white">
            Save
          </button>
        </div>
      </div>
    ...
    <div className="">
      <div className="w-full relative z-20    ">
        ...
        <div className="w-full  ">
          {" "}
          <div className=" fixed top-0 bg-purple-200  ">
            <MenuBar
              // @ts-ignore
              editor={editor}
              callback={saveEditor}
